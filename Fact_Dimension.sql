...
URL = "s3://instacart-ecom/instacart_data/"
Credentials = (AWS_KEY_ID = 'your_id' AWS_SECRET_KEY = 'your_key');
...
-- Creating tables from extracted data from kaggle instacart_data
CREATE TABLE aisles (
...
-- Transformation code to convert these tables into fact and dim 
